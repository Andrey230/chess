        ...
        <>
            ...
            <form onSubmit={loginForm}>
                ...
                <label className="input input-bordered flex items-center gap-2 mb-3">
                    ...
                    <input type="password" className="grow" placeholder="Password" value={password} name="password" onChange={(e) => setPassword(e.target.value)} />
                </label>

                <button className="btn btn-primary">Login</button>

                <NavLink to="/sign-up" className="block text-sm text-primary mt-3 text-right">Create account</NavLink>
            </form>
        </>
    );
}