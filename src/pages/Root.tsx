...
export default function Root(){
    ...
    const loadPgnVariant = () => {
        try {
            ...
            setGame(newGame);
            const newMoves = historyMoves.map((move) => {
                return {
                    from: move.from,
                    to: move.to,
                    san: move.san,
    ...
    const stepBack = () => {
        ...
        const newGame = new Chess(returnMove.before);
        setMoveCounter(moveCounter - 1);
        setGame(newGame);
    }
    ...
    const stepForward = () => {
        ...
        const nextMove = moves[moveCounter];
        if(!nextMove){
            return;
        }
        const newGame = new Chess(nextMove.after);
        setMoveCounter(moveCounter + 1);
        setGame(newGame);
    }
                ...
                <div className="p-5 pg:p-0 flex flex-col lg:flex-row justify-center gap-5 pt-28 items-start">
                    ...
                    <div className="w-full lg:w-1/3">
                        ...
                        <div className="flex mt-3 justify-center gap-5">
                            <button className={"btn shadow-xl " + (moveCounter > 0 ? "btn-success" : "btn-disabled")} onClick={stepBack}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-base-100" viewBox="0 0 320 512"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"/></svg>
                            </button>
                            <button className={"btn shadow-xl " + (moveCounter < moves.length ? "btn-success" : "btn-disabled")} onClick={stepForward}>
                                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-base-100" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                            </button>
                        </div>
                    </div>
                    <div className="p-5 shadow-xl bg-base-100 rounded-lg w-full lg:w-1/3 min-h-40 lg:min-h-[500px]">
                        ...
                        <div className="flex gap-2">
                            ...
                            {showVariantInput ? <div className="flex gap-2 mt-3">
                                ...
                                {showPgnInput ? <div className="flex gap-2 mt-3">
                                    <input type="text" placeholder="Paste pgn" value={pgn} className="input input-bordered w-full max-w-xs" onChange={changePgnInput} />
                                    <button className="btn btn-success" onClick={loadPgnVariant}>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 fill-base-100" viewBox="0 0 448 512"><path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg>
                                    </button>
                                </div> : ''}
